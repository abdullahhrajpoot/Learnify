...
export default function AdminNav() {
  ...
  const items = [
    { href: "/admin/dashboard", label: "Dashboard", Icon: LayoutDashboard, color: "text-black-500" },
    { href: "/admin/add", label: "Add", Icon: PlusCircle, color: "text-ocean-secondary" },
    { href: "/admin/edit", label: "Edit", Icon: Edit, color: "text-ocean-accent" },
    { href: "/admin/remove", label: "Remove", Icon: Trash2, color: "text-red-600" },
    { href: "/admin/assign", label: "Assign", Icon: Users, color: "text-purple-600" },
    { href: "/admin/expenses", label: "Expenses", Icon: DollarSign, color: "text-emerald-600" },
    { href: "/admin/sessions", label: "Sessions", Icon: CalendarClock, color: "text-amber-600" },
    { href: "/", label: "Site", Icon: Globe, color: "text-gray-600" },
  ];
