...
export default function GuardianNav() {
  ...
  const items = [
    { href: "/guardian/dashboard", label: "Dashboard", Icon: Home, color: "text-ocean-primary" },
    { href: "/guardian/students", label: "Students", Icon: GraduationCap, color: "text-ocean-secondary" },
    // { href: "/guardian/sessions", label: "Sessions", Icon: CalendarCheck, color: "text-ocean-accent" },
    { href: "/guardian/payments", label: "Payments", Icon: TrendingUp, color: "text-purple-600" },
    { href: "/guardian/buy-credits", label: "Buy Credits", Icon: FileText, color: "text-emerald-600" },
    { href: "/", label: "Site", Icon: Shield, color: "text-gray-600" },
  ];
