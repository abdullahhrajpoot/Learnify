...
export default function StudentNav() {
  ...
  const items = [
    { href: "/student/dashboard", label: "Dashboard", Icon: User, color: "text-ocean-primary" },
    { href: "/student/assignments", label: "Assignments", Icon: BookOpen, color: "text-ocean-secondary" },
    { href: "/student/sessions", label: "Sessions", Icon: CalendarClock, color: "text-ocean-accent" },
    { href: "/student/profile", label: "Profile", Icon: UserCheck, color: "text-purple-600" },
    { href: "/student/ai-tutor", label: "AI Tutor", Icon: MessageSquare, color: "text-emerald-600" },
