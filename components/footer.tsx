...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-ocean-primary/10 via-ocean-secondary/10 to-ocean-accent/10 border-t border-ocean-primary/20 py-8 mt-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold bg-gradient-to-r from-ocean-primary to-ocean-secondary bg-clip-text text-transparent">
                Learnify
              </span>
            </div>
